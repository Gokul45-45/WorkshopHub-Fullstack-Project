        ...
        <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="aspect-video rounded-2xl bg-neutral-900 border overflow-hidden relative group">
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-black to-transparent">
                    ...
                    <p className="text-white/70 text-sm">Continue where you left off</p>
                </div>
            </div>
                    ...
                    <div className="grid gap-6 lg:grid-cols-3">
                        <div className="lg:col-span-2 space-y-4">
                            <h3 className="font-display font-bold text-lg flex items-center gap-2">
                                <Zap className="h-5 w-5 text-accent" /> Course Modules
                            </h3>
                            {/* Mocked modules since original course data has module count but not titles sometimes */}
                            {[...Array(course.modules)].map((_, i) => (
                                <div key={i} className="rounded-xl border bg-card p-4 shadow-sm hover:border-accent/50 transition-all cursor-pointer group text-card-foreground">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            <div className="h-8 w-8 rounded-full bg-muted flex items-center justify-center group-hover:bg-accent/10 group-hover:text-accent font-bold text-xs">
                                                {i + 1}
                                            </div>
                                            <div>
                                                <p className="font-bold text-sm">Module {i + 1}: Advanced Concepts</p>
                                                <p className="text-xs text-muted-foreground">4 Lessons • 2h 30m</p>
                                            </div>
                                        </div>
