...
const StudentLogin = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    dispatch(login({ role: "student", userId: user.id, userName: user.name, email: user.email, avatar: user.avatar }));
    navigate("/student");
  };
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="rounded-xl border border-sidebar-border bg-card p-8 shadow-2xl">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <h2 className="font-display text-xl font-bold text-card-foreground">Student Login</h2>
          </div>
          ...
          <p className="mt-4 text-center text-sm text-muted-foreground">
            ...
            <Link to="/signup/student" className="text-accent hover:underline font-medium">Sign Up</Link>
          </p>
